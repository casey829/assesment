...
//           </Button>
//           <Button 
//             className="text-[#26272D] bg-[#F6F6F6] rounded-[100px] border border-[#A5A5A5] h-[48px] w-[130px] px-[20px] py-[16px] flex items-center justify-center hover:bg-[#A5A5A5]"
...
function NavBar() {
  ...
  useEffect(() => {
    ...
    window.scrollTo(0, 0);
  }, [location.pathname]); // This dependency ensures the effect runs on route change

  // This effect will handle page reload
  useEffect(() => {
    // Scroll to top on initial load/page reload
    window.scrollTo(0, 0);
